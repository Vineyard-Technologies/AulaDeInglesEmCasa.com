    ...
    <div className="min-h-screen bg-background py-20">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <LazyLoad delay={600} animationClass="fade-in-right">
            <section className="mb-8">
          ...
          <LazyLoad delay={700} animationClass="fade-in-left">
            <section className="mb-8">
          ...
          <LazyLoad delay={800} animationClass="fade-in-right">
            <section className="mb-8">
          ...
          <LazyLoad delay={900} animationClass="fade-in-scale">
            <section className="mb-8">
          ...
          <LazyLoad delay={1000} animationClass="fade-in-left">
            <section className="mb-8">
          ...
          <LazyLoad delay={1100} animationClass="fade-in-right">
            <section className="mb-8">
          ...
          <LazyLoad delay={1200} animationClass="fade-in-scale">
            <section className="mb-8">
          ...
          <LazyLoad delay={1300} animationClass="fade-in-left">
            <section className="mb-8">
