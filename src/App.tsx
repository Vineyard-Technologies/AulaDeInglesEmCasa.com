            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <p className="text-lg mb-6 text-muted-foreground leading-relaxed">
                  ...
                  ensinando estudantes brasileiros. Especializo-me em aulas particulares em domicílio, 
                  oferecendo um ambiente confortável e personalizado para o aprendizado.
                </p>
                
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                    <GraduationCap className="w-6 h-6 text-primary" />
                    <span>Certificação TEFL/TESOL</span>
                  </div>
                  <div className="flex items-center gap-3">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span>Mais de 200 alunos atendidos</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <Home className="w-6 h-6 text-primary" />
                    <span>Aulas no conforto da sua casa</span>
                  </div>
                </div>
              </div>
              ...
              <Card className="p-6">
                ...
                <CardContent className="space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <span className="text-sm">Abordagem comunicativa e interativa</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-secondary mt-0.5" />
                    <span className="text-sm">Material personalizado para cada aluno</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-secondary mt-0.5" />
                    <span className="text-sm">Foco na conversação e pronúncia</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-secondary mt-0.5" />
                    <span className="text-sm">Exercícios práticos para o dia a dia</span>
                  </div>
                </CardContent>
              </Card>
            </div>
